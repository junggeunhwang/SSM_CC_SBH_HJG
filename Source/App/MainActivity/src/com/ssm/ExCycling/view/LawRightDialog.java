...
public class LawRightDialog extends Dialog {
	...
	public LawRightDialog(Context context) {
		...
		chkLocationApply.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			
			@Override
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if(isChecked && chkRightApply.isChecked()){
		...
		chkRightApply.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			
			@Override
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if(isChecked && chkLocationApply.isChecked()){
					btnRight.setEnabled(true);
				}
				else
					btnRight.setEnabled(false);
