...
public class HomeLayout extends BaseFragmentLayout {
	...
	private boolean start_stop_biking_status = false;
	...
	public void init(){
		...
		btnStartToBicycle.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(start_stop_biking_status==false)
				{
					...
					//자전거타기 종료
					start_stop_biking_status = false;
				}
//				MainActivity.getInstasnce().getLayout().replaceFragment(R.layout.fragment_cruise_container);
	...
	public boolean isStart_stop_biking_status() {
		return start_stop_biking_status;
	}

	public void setStart_stop_biking_status(boolean start_stop_biking_status) {
		this.start_stop_biking_status = start_stop_biking_status;
	}
}
