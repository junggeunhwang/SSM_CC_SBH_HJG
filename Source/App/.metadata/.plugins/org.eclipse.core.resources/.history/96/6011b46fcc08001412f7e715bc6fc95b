	...
	public void init(){
		...
		btnStart.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				MainActivity.getInstasnce().getLayout().getmCruiseContainerFragment().getmHomeFragment().getLayout().convertStartBtn();
				MainActivity.getInstasnce().getLayout().getmCruiseContainerFragment().getmHomeFragment().getLayout().setStart_stop_biking_status(true);
			}
		});
