...
//	MapView map_view;
		...
		MainActivity.getInstasnce().runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				for(int i = 0 ; i < SettingsDataManager.getInstance().getCurrentRoomFriendList().size() ; i++){
					if(SettingsDataManager.getInstance().getCurrentRoomFriendList().get(i).getCurrentLocation()!=null){
						addMarker(SettingsDataManager.getInstance().getCurrentRoomFriendList().get(i).getCurrentLocation().getLatitude(),
								SettingsDataManager.getInstance().getCurrentRoomFriendList().get(i).getCurrentLocation().getLongitude(),
								SettingsDataManager.getInstance().getCurrentRoomFriendList().get(i).getUserName());
					}
				}
			}
		});
	...
	public void addMarker(final double lattitude,final double longitude,final String name){
//		MainActivity.getInstasnce().runOnUiThread(new Runnable() {
//			
//			@Override
//			public void run() {
