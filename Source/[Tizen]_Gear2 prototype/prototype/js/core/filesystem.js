 ...
 * Filesystem helper
 */
var filesystem = function coreFilesystem() {
        'use strict';
         ...
         * @param {string} opentype -> a,rw,r,w.
         */
        function writeFile(handle, content, err, opentype) {
            err = err || noop;

            handle.openStream(opentype, function writeFile(fileStream) 
            {
